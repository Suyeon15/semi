...
public class CommentsDAO {
		   ...
		   public int modify(String cmt_content, int cmt_seq) throws Exception{
		      String sql ="update comments set cmt_content=? where cmt_seq=?";
		      try(Connection con = this.getConnection(); 
		            PreparedStatement pstat = con.prepareStatement(sql)){
		         pstat.setString(1, cmt_content);
